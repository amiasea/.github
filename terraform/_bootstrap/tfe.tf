...
resource "tfe_variable" "azure_environment" {
  ...
  value = join("\n", [
    ...
    "  }",
    "  authority_principal = {",
    "    institutive = \"241cd7c9-cc16-416e-91c0-df11b35846fa\"",
    "    speculative = \"241cd7c9-cc16-416e-91c0-df11b35846fa\"",
    "    prospective = \"241cd7c9-cc16-416e-91c0-df11b35846fa\"",
    "    operative   = \"241cd7c9-cc16-416e-91c0-df11b35846fa\"",
    "  }",
    "}",
    "",
  ])
